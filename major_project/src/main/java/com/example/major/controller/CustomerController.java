...
//	private void updateRouter(@PathVariable("serialNumber") String serialNumber,@RequestParam RouterDetails router) {
...
//	}
	...
	public String payBill(@RequestBody Plans plannow) {
		//System.out.println("hello by routers");
		return customerService.paybill(plannow);
